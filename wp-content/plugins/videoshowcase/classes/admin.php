...
//$this->_options['groups'][$_POST[$this->_var . '-groupid']]['videos'][$_POST[$this->_var . '-videoid']]['vimage'] = $attachment_data['attachment_id'];
		...
		function admin_menu() {
			if ( isset( $this->_parent->_series ) && ( $this->_parent->_series != '' ) ) {
				...
				add_menu_page($this->_parent->_name.' Getting Started', $this->_parent->_name, 'administrator', $this->_parent->_var, array(&$this, 'view_gettingstarted'), $this->_parent->_pluginURL.'/images/it-logo.png');
