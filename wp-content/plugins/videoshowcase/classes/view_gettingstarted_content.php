...
global $PluginBuddyVideoShowcase;
...
?>
	...
	<div id="pluginbuddy_videoshowcase_debugtoggle_div" style="display: none;">
		...
		<?php
			$file_data = get_file_data( dirname( dirname( __FILE__ ) ) . '/videoshowcase.php', array( 'version' => 'Version' ) );
			...
			echo "Plugin Version = {$PluginBuddyVideoShowcase->_name} $version ({$PluginBuddyVideoShowcase->_var})\n";
