<?php
	...
	elseif (CMS_PLATFORM == 'WordPress'){
    	...
    	define ('CMS_USER_SCRIPT','index.php?option=com_topquark');
    	define ('CMS_ADMIN_PATH','wp-admin/');
    	define ('CMS_ADMIN_COM_PATH','wp-content/plugins/topquark/admin/');
    	define ('CMS_INSTALL_PATH','wp-content/plugins/topquark/');
	...
	if (CMS_PLATFORM == 'WordPress'){
		if (is_multisite()){
			...
			define ('CMS_ASSETS_DIRECTORY','wp-content/assets/');
		}
	}
	else{
