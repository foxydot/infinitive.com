...
*************************************************************/
    ...
    ***********************************************************************/
    ...
    $ShowTab = new HTML_Tab('Show',$ShowType);
        ...
        $ShowTab->addTextArea('ShowDescription', 'Brief Description:',$Show->getParameter('ShowDescription'),50,3,0);
    ...
    ***********************************************************************/
    ...
    $ArtistsTab = new HTML_Tab('Artists',pluralize('Artist'));
        ...
        $ArtistSelection.= "<td width=44% valign=top>".pluralize('Artist')." in the $ShowType<br><select name='ShowArtists' multiple='multiple' size=10 style='width: 100%'>\n";
