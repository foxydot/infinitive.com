...
add_filter( 'genesis_search_form', 'msdlab_search_form' );
...
add_action( 'genesis_entry_content', 'genesis_post_meta', 14); //remove the meta (filed under, tags, etc.)
...
//add_action( 'genesis_entry_content', 'msdlab_post_image', 8 ); //add feature image across top of content on *pages*.
